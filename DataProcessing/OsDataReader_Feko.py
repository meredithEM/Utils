...
def OsDataReader_Feko(files_path, samples_num, model_name, read_mode, output_path):
    ...
    torch.save(e_location_feature_tensor, os.path.join(output_path, f'{model_name}_e_location_feature.pt'))
    torch.save(m_location_feature_tensor, os.path.join(output_path, f'{model_name}_m_location_feature.pt'))
    
    torch.save(e_current_label_tensor, os.path.join(output_path, f'{model_name}_e_current_label.pt'))
    torch.save(m_current_label_tensor, os.path.join(output_path, f'{model_name}_m_current_label.pt'))
